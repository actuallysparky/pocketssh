                               ...
                               const std::string &session_token)
{
    ...
    size_t ignored_preheader_lines = 0;
    size_t ignored_preheader_bytes = 0;
    ...
    if (ignored_preheader_lines != 0) {
        ESP_LOGW(TAG, "POCKETCTL serialrx_discarded_preheader lines=%u bytes=%u",
                 static_cast<unsigned>(ignored_preheader_lines),
                 static_cast<unsigned>(ignored_preheader_bytes));
    }
